    ...
    <header className="flex justify-between items-center | sticky top-0 sm:px-8 | h-[6rem] card--blur z-10 px-4">
      <div className="flex justify-between items-center | w-full">
        ...
        <div className="flex space-x-3 text-primary-700">
          <Link to="/activity" className="btn btn-outline bg-white rounded-2xl hover:bg-white hover:border-gray-300 hover:text-gray-500 w-[50px] md:w-[185px]">
            <Bell size={18} />
            <span className="hidden md:block">
              My activity
            </span>
          </Link>
          <CustomConnectButton id="topbar-connect-wallet" className="btn rounded-2xl w-[185px] hover:border-gray-300 hover:bg-primary-500" chainStatus="icon" tooltip>
